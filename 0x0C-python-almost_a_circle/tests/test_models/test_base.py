...
class TestBase(unittest.TestCase):
    ...
    def test_nb_is_private(self):
        '''Test if nb_objects is a private instance attribute'''
    ...
    def test_excess_args(self):
        ...
        message = "__init__() takes from 1 to 2 positional arguments but 3 were given"
        self.assertEqual(str(excep.exception), message)
    ...
    def test_string_variable(self):
        '''Test id dependent on a string variable'''
        string = "test_string"
        Btest = Base(string)
    ...
    def test_json_string(self):
        ...
        with self.assertRaises(TypeError) as excep:
            Base.to_json_string()
        message = "to_json_string() missing 1 required positional argument: 'list_dictionaries'"
        self.assertEqual(str(excep.exception), message)
        ...
        dic = [{'th': 7}, {'test_dict': 3}]
        dic_json = '[{"th": 7}, {"test_dict": 3}]'
    ...
    def test_from_json_string(self):
        ...
        message = "from_json_string() missing 1 required positional argument: 'json_string'"
        self.assertEqual(str(excep.exception), message)
...
{"x": 4, "y": 19, "width": 7, "id": 13, "height": 9}]'
        ...
        string = '[{"test_key": 5, "test_value": 9, "dummy": 11, "is": 1, "sample": 6}, \
{"a": 4, "b": 19, "c": 7, "d": 13, "e": 9}]'

        dic = [{'test_key': 5, 'test_value': 9, 'dummy': 11, 'is': 1, 'sample': 6},
               {'a': 4, 'b': 19, 'c': 7, 'd': 13, 'e': 9}]
